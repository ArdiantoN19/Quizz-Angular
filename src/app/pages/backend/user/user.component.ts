...
import { DialogConfirmUserAppComponent } from '../../../components/backend/user/dialog/dialog-confirm/dialog-confirm.component';
...
import { DialogFormUserAppComponent } from '../../../components/backend/user/dialog/dialog-form/dialog-form.component';
...
export class UserPageApp implements OnInit {
  ...
  onDeleteHandler(dataDelete: TUser) {
    const dialogRef = this.dialog.open(DialogConfirmUserAppComponent, {
      data: {
        id: dataDelete.id,
      },
    });
